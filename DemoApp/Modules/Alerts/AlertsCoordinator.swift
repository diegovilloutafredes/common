...
// MARK: - AlertsCoordinatorProtocol

@MainActor
protocol AlertsCoordinatorProtocol: AnyObject {
    func showCustomAlert(style: CustomAlertStyle)
}

// MARK: - AlertsCoordinator

final class AlertsCoordinator: BaseCoordinator {
    override func start() {
...
extension AlertsCoordinator: AlertsCoordinatorProtocol {
    func showCustomAlert(style: CustomAlertStyle) {
        switch style {
        case .basic:
            presentCustomAlert(
