...
public final class URLEncodedFormEncoder {
    ...
    public struct KeyPathEncoding {
        ...
        init(encoding: @escaping (_ subkey: String) -> String) {
    ...
    ///   - allowedCharacters:        The `CharacterSet` of allowed (non-escaped) characters. `.urlQueryAllowed` by
    ///                               default.
